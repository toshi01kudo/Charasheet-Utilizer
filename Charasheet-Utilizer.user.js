        ...
        const henge_const = [
            {
                ...
                'name': '道怪',
                'skills': [ // ID = 8 道怪
                    ["やみよ", 4, "この［場面］が終わるまで、闇の中では ［へんげ］が一時的に 2 増える。 夜しか使えない。"],
                    ["ばったり", 6, "「道を歩いている」相手さえいれば、登場していない［場面］でも登場することができます。必ずそこにいた人やもののけを［びっくり］させたかどうか、判定しなくてはいけません。"],
                    ["おくりあし", 6, "この［特技］ を使っている道怪を、相手は目で見ることができません。 けれど、道怪自身も相手に触れたり追いついたりはできません。追いかけられている相手は、こわくて［おとな］ が0 になってしまいます。 この効果は［場面］が変わるまで続きます。"],
            ...
            },
            {
                ...
                'name': '鬼',
                'skills': [ // ID = 9 鬼
                    ["ちからもち", 0, "重いものを持ち上げたり、腕相撲をしたりして力の強さで判定する時は［けもの］が2 倍になります。 ただし、［想い］ で増やした分は 2 倍にはなりません。",""],
                    ["かみなり", 8, "空に雷を呼んで大きな雷を起こします。雷が人に落ちてきたりすることはありませんが、すごい迫力です。同じ［場面］にいる鬼以外の全員は、 ［おとな］が4 以上ないと悲嗚をあげて逃げだしてしまいます。",""],
            ...
            },
            {
                ...
                'name': '蛇',
                'skills': [ // ID = 15 蛇
                    ["こあくま", 0, "異性のキャラクター（語り手が許可するなら同性も）との［出会い］で相手からの ［つながり］を1強くできる。また、相手の持つ ［つながり］の内容は蛇が決められる。", ""],
            ...
            },
            {
                ...
                'name': '天狗',
                'skills': [
                    ["こあくま", 0, "異性のキャラクター（語り手が許可するなら同性も）との［出会い］で相手からの ［つながり］を1強くできる。また、相手の持つ ［つながり］の内容は蛇が決められる", "42"],
                    ["つばさ", 2, "空を飛べる。自身より小さいものなら持って飛べる。逃げたり、ものを探したりするときに能力値を2増やせる。ただし、完全な人間の時には使えない", "42"],
                    ["はねうちわ", 4, "風を思うままに吹かせる。強い風も出せるが、重い物は動かせない", "42"],
                    ["そらきだおし", 6, "声や森の物音をまねできる。【へんげ】を上回る相手は見破ることができる。轟音で[びっくり]させることもでき、相手は天狗の【へんげ】と任意の能力値で判定する", "42"],
                    ["まっくら", 12, "辺りを夜のように暗くし、夜として扱う。【こども】が3以上の人は、【こども】以外の能力値を0とする（もののけは影響なし）。[場面]が終わるまで続く。鬱蒼と木が茂るところでのみ使える", "42"],
                    ["かみかくし", 16, "もののけの里「隠れ里」へ入る。選んだ誰とでも同意なしに一緒に行ける。抵抗するなら、天狗の【へんげ】と相手の任意の能力値で判定。もののけは隠れ里を自由に出入りできるが、人はもののけと一緒でないと出入りできない", "42"]
                ]
            },
            {
                'ID': 23,
                'name': '龍',
                'skills': [
                    ["あまかける", 2, "空を飛べる。自身より小さいものなら持って飛べる。逃げたり、ものを探したりするときに能力値を2増やせる。ただし、完全な人間の時には使えない", "46"],
            ...
            },
            {
                ...
                'skills': [
                    ...
                    ["なでなで", 6, "同じ[場面]にいるキャラクター1人に撫でてもらうと【つながり】と同じだけ【想い】を得る。（ちゃんと相手に撫でてもらうこと！）", "50"],
                    ["だいじょうぶ", 6, "相手を安心させる。[びっくり]やケンカで負けたキャラクターを元気づけて、その状態から開放する", "50"],
                    ["みがわり", 8, "誰かが危険な目に会いそうな時、身代わりになれる。登場してなくても好きなタイミングで登場し、身代わりになれる", "50"]
                ]
            },
            {
                'ID': 25,
